...
void setup() {
  size(800, 600);
  all = new Gif ("ponyGif/pony", ".gif", 38, 3, 0, 0, width/2, height/2); //, width, height  
  rainbowdash = new Gif ("flying/fly", ".gif", 30, 1, 0, 0, width/4, height/4);
  spark = new Gif ("spark/twilight", ".gif", 20, 2, 0, 0, width/3, height/3);
