...
//1 time day 1 time night
//if (sunY<0) { //NEED CONDITION
//  day = !day; //flip the switch->becomes false
//}
...
void draw() { 
  ...
  pushMatrix();
  //no trailing
  background (75, 63, 114);
    
  //bigger circle
    fill (yellow);
    stroke (yellow);
    circle (125, moonY, 100);
  //needed to make moon
    fill (75, 63, 114);
    noStroke ();
    circle (145, moonY, 100);
  
    moonY = moonY - 2; //assign variable so it moves every frame
